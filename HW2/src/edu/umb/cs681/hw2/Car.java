...
public class Car {
	...
	public static void main(String[] args) {
		...
		list.add(new Car("Tesla", "S", 15, 2018, 100000));
		list.add(new Car("BMW", "X6", 10, 2002, 160000));
		list.add(new Car("Benz", "S400", 18, 2020, 240000));
		list.add(new Car("McLaren", "720s", 12, 2019, 1380000));
